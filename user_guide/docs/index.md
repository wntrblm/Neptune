...
![Illustration of power connection](images/power-connection.svg)
...
![Neptune illustration](images/front.svg)
...
![Audio inputs](images/interface-audio-inputs.svg)
...
![Audio output](images/interface-output.svg)
...
![Cutoff frequency controls](images/interface-cutoff.svg)
...
![Audio inputs](images/interface-cutoff-formula.svg)
...
![Resonance controls](images/interface-resonance.svg)
...
![Salt controls](images/interface-salt.svg)
...
![Low pass filter patch](images/patch-lpf.svg)
...
![High pass filter patch](images/patch-hpf.svg)
...
![High/low shelf filter patch](images/patch-shelf.svg)
...
<winter-audio-player title="High/low shelf filter">
...
![Spectral crossfader patch](images/patch-spectral.svg)
...
<winter-audio-player title="High/low-pass crossfade">
...
<winter-audio-player title="Clean self-oscillation">
...
<winter-audio-player title="Full self-oscillation">
...
<winter-audio-player title="Salty self-oscillation">
...
<winter-audio-player title="Basic low-pass synth voice">
    <source src="./media/simple-low-pass-filter-synth-voice-loop.flac" type="audio/flac" />
    <source src="./media/simple-low-pass-filter-synth-voice-loop.m4a" type="audio/x-m4a" />
</winter-audio-player>
...
<winter-audio-player title="Spectral crossfading synth voice" loop>
...
<winter-audio-player title="Chaotic oscillator">
